...
DirectoryIndex index.htm
		...
		<Item Name="Begin subVIs" Type="Folder" URL="../Begin subVIs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Finish subVIs" Type="Folder" URL="../Finish subVIs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		...
		<Item Name="Teleop subVIs" Type="Folder" URL="../Teleop subVIs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="TimedTasks subVIs" Type="Folder" URL="../TimedTasks subVIs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="TypeDefs" Type="Folder" URL="../TypeDefs">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Arm Documentation VI.vi" Type="VI" URL="../../../Desktop/Arm Documentation VI.vi"/>
		<Item Name="find facing.vi" Type="VI" URL="../Pure Pursuit/generate path/find facing.vi"/>
		<Item Name="Robot Main.vi" Type="VI" URL="../Robot Main.vi"/>
		<Item Name="Vision Process.vi" Type="VI" URL="../Pure Pursuit/generate path/Vision Process.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="add points.vi" Type="VI" URL="../Pure Pursuit/generate path/add points.vi"/>
			<Item Name="autonomous pure pursuit.vi" Type="VI" URL="../Pure Pursuit/autonomous pure pursuit.vi"/>
			<Item Name="curvature to lookahead point.vi" Type="VI" URL="../Pure Pursuit/follow path/curvature to lookahead point.vi"/>
			<Item Name="diagnostics.vi" Type="VI" URL="../Pure Pursuit/diagnostics.vi"/>
			<Item Name="dist and curvature.vi" Type="VI" URL="../Pure Pursuit/generate path/dist and curvature.vi"/>
			<Item Name="distance formula.vi" Type="VI" URL="../Pure Pursuit/distance formula.vi"/>
			<Item Name="facing subvi.vi" Type="VI" URL="../Pure Pursuit/generate path/facing subvi.vi"/>
			<Item Name="find closest point.vi" Type="VI" URL="../Pure Pursuit/follow path/find closest point.vi"/>
			<Item Name="find lookahead point.vi" Type="VI" URL="../Pure Pursuit/follow path/find lookahead point.vi"/>
			<Item Name="find robot location.vi" Type="VI" URL="../Pure Pursuit/follow path/find robot location.vi"/>
			<Item Name="FRC_NetworkCommunication.dll" Type="Document" URL="FRC_NetworkCommunication.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="generate path.vi" Type="VI" URL="../Pure Pursuit/generate path/generate path.vi"/>
			<Item Name="gradient descent 2.0.vi" Type="VI" URL="../Pure Pursuit/generate path/gradient descent 2.0.vi"/>
			...
			<Item Name="path data.ctl" Type="VI" URL="../Pure Pursuit/path data.ctl"/>
			<Item Name="pure pursuit.vi" Type="VI" URL="../Pure Pursuit/pure pursuit.vi"/>
			<Item Name="reset sensors.vi" Type="VI" URL="../Pure Pursuit/reset sensors.vi"/>
			<Item Name="velocity profile.vi" Type="VI" URL="../Pure Pursuit/generate path/velocity profile.vi"/>
			<Item Name="waypoints from vision.vi" Type="VI" URL="../../_Louise/pure pursuit/waypoints from vision.vi"/>
			<Item Name="wheel velocities.vi" Type="VI" URL="../Pure Pursuit/follow path/wheel velocities.vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="Source[0].itemID" Type="Str">{F137F02C-1FA1-4CB0-834F-BA3D37A0CCFC}</Property>
